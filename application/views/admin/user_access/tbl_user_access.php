...
?> -->
 <div class="col-md-7 align-self-center text-right d-none d-md-block">
      <?php  if(getUserAccessForModule('User','create')): ?>
      <a href="<?= base_url('admin/UserAccess/add_user');?>" class="btn btn-info btn-theme"><i class="fa fa-plus-circle"></i> Create User Access </a>
    <?php endif; ?>
   </div>   
</div>
...
<div class="table-responsive">
    <table id="user_access" class="table display table-responsive  no-wrap  table-bordered text-center" width="100%">
