     ...
     <div class="scroll-sidebar">
         ...
         <nav class="sidebar-nav">
             <ul id="sidebarnav">
                 ...
                 <?php if (getUserAccessForModule('Indent', 'is_menu') || userId('role_id') == SUPERADMIN_ROLE): ?>
                     ...
                     <li>
                         ...
                         <ul aria-expanded="false" class="collapse">
                             ...
                             <li><a href="<?= base_url('admin/indent/master/Clamp/Clamp_type') ?>">Clamp Type</a></li>
                             <li><a href="<?= base_url('admin/indent/master/Clamp/Clamp_material') ?>">Clamp Material</a></li>
                 ...
                 <?php endif; ?>
                 <li>
                     <a class="text-color" href="#" aria-expanded="false">
                     ...
                     <ul aria-expanded="false" class="collapse">
                         ...
                         <?php if ($company_id == ENCON_COOLING_TOWERS_PVT_LTD_PLOT_NO_B_101_SINNAR): ?>

                             <!-- Carbon Fiber Drive Shaft -->
                             <li>
                                 <a href="<?= base_url('admin/production/Indent/carbonfiberdriveshaft_indent') ?>">
                                     Carbon Fiber Drive Shaft
                                 </a>
                             </li>

                             <li style="border-bottom: 0.2px solid #ccc;">
                                 <a href="<?= base_url('admin/production/Indent/cfds_received_order') ?>">
                                     Carbon Fiber Drive Shaft Received Orders
                                 </a>
                             </li>

                             <!-- FRP Header Pipe -->
                             <li>
                                 <a href="<?= base_url('admin/production/Indent/frp_header_pipe_indent') ?>">
                                     FRP Header Pipe
                                 </a>
                             </li>

                             <li style="border-bottom: 0.2px solid #ccc;">
                                 <a href="<?= base_url('admin/production/Indent/frp_header_pipe_received_order') ?>">
                                     FRP Header Pipe Received Orders
                                 </a>
                             </li>

                             <!-- FRP Clamp -->
                             <li>
                                 <a href="<?= base_url('admin/production/Indent/frp_clamp_indent') ?>">
                                     FRP Clamp
                                 </a>
                             </li>

                             <li style="border-bottom: 0.2px solid #ccc;">
                                 <a href="<?= base_url('admin/production/Indent/frp_clamp_received_order') ?>">
                                     FRP Clamp Received Orders
                                 </a>
                             </li>

                         <?php elseif ($company_id == BALAJI_PLANT): ?>

                             <li>
                                 <a href="<?= base_url('admin/production/Indent') ?>">Indent</a>
                             </li>

                             <li>
                                 <a href="<?= base_url('admin/production/SemifinishedList') ?>">
                                     Received Semifinished Products List
                                 </a>
                             </li>

                             <li>
                                 <a href="<?= base_url('admin/production/StockList') ?>">
                                     Stocklist
                                 </a>
                             </li>

                         <?php elseif ($company_id == ENCON_INTERNATIONAL): ?>

                             <li>
                                 <a href="<?= base_url('admin/production/Indent/hub_indent') ?>">Hub</a>
                             </li>

                             <li>
                                 <a href="<?= base_url('admin/production/Indent/hub_received_order') ?>">
                                     Hub Received Orders
                                 </a>
                             </li>
                             <!-- <li>
                                 <a href="<?= base_url('admin/production/Indent/fan_dia_indent') ?>">Fan Dia Indent</a>
                             </li>

                             <li>
                                 <a href="<?= base_url('admin/production/Indent/fan_dia_received_order') ?>">
                                     Fan Dia Received Orders
                                 </a>
                             </li> -->
                         ...
                         <?php else: ?>
                             ...
                             <li>
                                 <a href="<?= base_url('admin/production/ReceivedOrders') ?>">
                                     Received Orders
                                 </a>
                             </li>
                     ...
                     <li class="one-column"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="icon-Management"></i><span class="hide-menu">Master Module</span></a>
                         <ul aria-expanded="false" class="collapse">
                             ...
                             <?php
                                ...
                                ?>
                                 <li><a href="<?= base_url('admin/Vendor'); ?>">Vendor</a>
                                 <li>
                 ...
                 <?php if (userId('role_id') == SUPERADMIN_ROLE  || getUserAccessForModule('Sales', 'is_menu')): ?>
                     <li class="one-column"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="icon-Administrator"></i><span class="hide-menu">Sales</span></a>
                         <ul aria-expanded="false" class="collapse">
                             ...
                             <li><a href="<?= base_url('admin/sales/quotation') ?>"> Quotation</a></li>
                             <li><a href="<?= base_url('admin/sales/OC') ?>"> OC</a></li>
                         </ul>
                     </li>
                     <li class="one-column"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="icon-Administrator"></i><span class="hide-menu">Sales Master</span></a>
                         <ul aria-expanded="false" class="collapse">
                             <li><a href="<?= base_url('admin/sales/master/TechnicalSpecification') ?>">Master Technical Specification</a></li>
                             <li><a href="<?= base_url('admin/sales/master/FooterNotes') ?>">Master Footer Notes</a></li>
                         </ul>
                     </li>
                 <?php
                    endif;
 ...
 <script>
     ...
     var _admin = '<?= ADMIN ?>';
     var superadmin_role_id = '<?= SUPERADMIN_ROLE; ?>';
     var company_id = '<?= userId('company_id') ?>';
     var site_id = '<?= userId('site_id') ?>';
     var login_role = '<?= userId('role_id') ?>';
     var login_parent_role = '<?= userId('parent_staff_role') ?>';
 </script>