   <!-- ============================================================== -->
        ...
        <style>
            ...
            @media (min-width: 768px) {
                .mini-sidebar .sidebar-nav #sidebarnav > li > ul {right: -76px !important;}
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <!-- Profile -->
                        <!-- ============================================================== -->
                        <li class="nav-item dropdown mega-dropdown"> <a class="nav-link  waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><p class="text-white"><?= userId('company_site_name'); ?></p><p class="text-white"><?= userId('company_financial_year'); ?></p></a>

                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo base_url(USER_PROFILE);?><?= (userId('image'))? userId('image') : 'no_image.jpg' ?>" alt="user" class="profile-pic" /></a>
                                ...
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                <h4><?= userId('name');?></h4>
                                                <p class="text-muted"><?= userId('email');?></p><a href="<?= base_url();?>admin/Auth/Profile" class="btn btn-rounded btn-danger btn-theme btn-sm">View Profile</a></div>
                                        </div>
                                    </li>
              ...
              <button class="right-side-toggle waves-effect waves-light btn-inverse btn btn-circle btn-theme pull-right m-l-10"><i class="ti-settings text-white"></i></button>
        </header>
