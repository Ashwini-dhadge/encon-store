     ...
     <div class="row">
         <div class="col-md-3">
             <label>Vendor</label>
             <select class="form-control custom-select select2 get_vendor" style="width:100%" name="vendor_id" id="vendor_id" onchange="po_filter_view()" required>
         ...
         <div class="col-md-3">
             <label>Compnay</label>
             <select class="form-control select2 did-floating-select" id="company_id" name="company_id" value="" onchange="po_filter_view()">
                 <option value="">Select</option>
                 <option value="all">All</option>
                 <?php
         ...
         <div class="col-md-4">
             ...
             <select class="form-control select2 did-floating-select get_site" id="site_id" name="site_id" value="" onchange="po_filter_view()">
                 <option value="">Select</option>
                 <option value="all">All</option>
         ...
         <div class="col-md-2">
             <label>PO Date</label>
             <select class="form-control select2 did-floating-select" id="on_date" name="on_date" value="" onchange="po_filter_view()">
                 <option value="">Select </option>
     ...
     <div class="table-responsive">
         <table id="tbl_po_view" class="table display table-bordered text-center" width="100%">
         </table>
     </div>