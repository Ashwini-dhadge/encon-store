                           ...
                           <tr>
                            ...
                            <tbody  data-repeater-item  class="repeater-item main_tbl_reapter">
                             ...
                             <tr name="reapter_item_row" class="repeater-item1">
                              ...
                              <td>
                                 <div class="form-group ">                                                                     
                                    <input type="text" class="form-control po_item_cal numberonly" required name="item_unit" value="0" onkeydown="calculatePOItemEvent(event,this)" onblur="calculatePOItem(this)">
