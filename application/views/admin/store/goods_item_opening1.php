                           ...
                           <tr>
                            ...
                            <tbody  data-repeater-item  class="repeater-item main_tbl_reapter">
                             ...
                             <tr name="reapter_item_row" class="repeater-item1">
                              ...
                              <td>
                                 <div class="form-group ">                                                                     
                                    <input type="text" class="form-control po_item_cal numberonly" required name="item_unit" value="0" onkeydown="calculatePOItemEvent(event,this)" onblur="calculatePOItemEvent(event,this)">
                              ...
                              <td>
                                 <div class="form-group ">
                                    <input type="text" class="form-control po_item_cal allow_decimal" name="item_weight" placeholder="Weight" value="0" onkeydown="calculatePOItemEvent(event,this)"  onblur="calculatePOItemEvent(event,this)">
                              ...
                              <td>
                                 <input type="text" class="form-control po_item_cal allow_decimal" placeholder="item Rate" name="item_unit_rate" value="0" onkeydown="calculatePOItemEvent(event,this)"  onblur="calculatePOItemEvent(event,this)">
                     ...
                     <div class="row">
                        <div class="col-md-5">
                           <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                 <textarea class="form-control" name="remark" id="" rows="3"><?= isset($remark)?$remark:'';?></textarea>
                              </div>
                           </div>
                        </div>
...
<script src="<?= base_url(); ?>/assets/js/page-js/store/opening_repeater.js"></script>
<script src="<?= base_url(); ?>/assets/js/page-js/store/goods_item_opening.js"></script>
<script src="<?= base_url(); ?>/assets/js/multiple_image.js"></script>
