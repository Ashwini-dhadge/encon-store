                           ...
                           <div class="form-group row">
                              ...
                              <div class="col-md-8">
                                 <div class="input-group" style="width:60%">
                                    <input type="text" class="form-control mydatepicker" placeholder="mm/dd/yyyy" name="grn_date" id="grn_date" value="<?= isset($grn_date)?$grn_date:"" ?>" required>
                              ...
                              <td>
                                ...
                                <?php
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-6">
                                       <input type="text" class="form-control" name="batch_no" value="<?= isset($po_items['batch_no'])?$po_items['batch_no']:""; ?>" required>
                                    </div>
                                 </div>
                                 <div class="form-group">
                                    <label class="control-label text-left col-md-12">Expired Date</label>
                                    <div class="col-md-6">
                                       <input type="date" class="form-control "data-rule-futureDate="true" name="expired_date" required value="<?= isset($po_items['expired_date'])?$po_items['expired_date']:""; ?>">
                                    </div>
                                 </div>
                              </td>
                              <td>
                                       ...
                                       <select class="form-control " required name="weight_unit">
                                          <?php
                                             foreach($po_items['item_unit_list'] as $key_i2=>$value_item2){
                                                 ...
                                                 $selected='';
                                                if((isset($po_items['item_unit_id'])&& $po_items['item_unit_id']==$value_item2['id'])||(isset($po_items['item_weight_unit'])&& $po_items['item_weight_unit']==$value_item2['id'])){
                                                   $selected="selected";
                                                }
                                             ?>
                                          <option value="<?= $value_item2['id']; ?>" <?= $selected; ?>><?= $value_item2['short_name'] ?></option>
                        ...
                        <div class="table-responsive" >
                           <table class="table table-bordered">
                              ...
                              <tr>
                                 ...
                                 <td width="15%" class="">
                                    <div class="form-group">
                                       <input type="text" class="form-control po_item_cal_final" name="packing_forwarding_amount" id="packing_forwarding_amount" value="<?= (isset($grn_info['packing_forwarding_amount']))?$grn_info['packing_forwarding_amount']:'0'; ?>">
                                    </div>
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td width="15%" class="">
                                    <div class="form-group">
                                       <input type="text" class="form-control po_item_cal_final" name="n_tax_amount" id="n_tax_amount" value="<?= (isset($grn_info['new_tax_amount']))?$grn_info['new_tax_amount']:'0'; ?>">
                                    </div>
                                 </td>
                              </tr>
                              <td>
                              ...
                              <td class="">
                                 <div class="form-group">
                                    <label></label>
                                    <input type="text" class="form-control po_item_cal_final" name="new_tax_rate" id="new_tax_rate" readonly value="<?= (isset($grn_info['new_tax_rate']))?$grn_info['new_tax_rate']:'0'; ?>">
                                 </div>
                              </td>
                              <td>  <label></label>%</td>
                              <td class="">
                                 <div class="form-group">
                                    <label></label>
                                    <input type="text" class="form-control po_item_cal_final" name="new_tax_amount" readonly id="new_tax_amount" value="<?= (isset($grn_info['new_tax_amount']))?$grn_info['new_tax_amount']:'0'; ?>">
                                 </div>
                              </td>
                              </tr>
                              <tr>
                                 ...
                                 <td width="15%" class="">
                                    <div class="form-group">
                                       <input type="text" class="form-control po_item_cal_final allow_decimal" name="service_charge_amount" id="service_charge_amount" value="<?= (isset($grn_info['service_charge_amount']))?$grn_info['service_charge_amount']:'0'; ?>">
                                    </div>
                                 </td>
                              </tr>
                              <td>
...
<script src="<?= base_url(); ?>assets/js/page-js/add_goods_receipt_note_repeater.int.js?v=1.0.6"></script>
<script src="<?= base_url(); ?>/assets/js/page-js/store/grn_cal.js?v=1.0.7"></script>
<script>
