         ...
         <div class="card-body">
            <div class="row">
               ...
               <div class="col-md-7 align-self-center text-right d-none d-md-block">
                  <?php  if(getUserAccessForModule('Store','create')): ?>
            ...
            <div>
               ...
               <div class="col-md-2">
                 ...
                 <div class="col-md-2">
                  ...
                  <select class="form-control select2 did-floating-select item_group_name"  id="id_itemgroup"   name="id_itemgroup" value="" onchange="grn_filter()">
...
<?php  init_footer(); ?>
<script src="<?= base_url(); ?>assets/js/page-js/store/grn.js?v=1.0.5"></script>
