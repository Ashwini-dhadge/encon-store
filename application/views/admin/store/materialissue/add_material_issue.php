               ...
               <div class="row">
                ...
                //   echo $issue_info['issue_date'];die;
                    ...
                    if(isset($issue_info['issue_number'])){
                        ...
                        $number=generate_material_issue_number();
                        if(isset($number['new_number'])){
                            $unqie_no=$number['new_number'];
                            $order_sequence=isset($number['order_sequence'])?$number['order_sequence']:"0";
                        }else{
                     ...
                     <div class="row">
                        ...
                        <div class="form-group col-md-3 ">
                           ...
                           <input type="text" class="form-control" name="issue_number" readonly value="<?= $unqie_no;?>">
                            <input type="hidden" class="form-control" name="issue_order_sequence" readonly value="<?= isset($number['order_sequence'])?$number['order_sequence']:"0";?>">
                        </div>
                            ...
                            <table class="table table-bordered main_tbl_reapter"  data-repeater-item>
                              ...
                              <tr name="tr_name">
                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-12">
                                       <select class="form-control custom-select select2 po_items_select po_items_select_1" name="items_id" style="width:100%" onchange="getItemUnits(this)">
                                          <?php
                                    ...
                                    <div class="form-group col-md-12 m-t-20">
                                       ...
                                       <div class="form-group ">                                                                     
                                          ...
                                          foreach($po_items['item_unit_list'] as $key_i2=>$value_item2){
                                              ...
                                              $selected='';
                                             if($po_items['item_weight_unit']==$value_item2['id']){
                                                $selected="selected";
                                             }
                                          ?>
                                       <option value="<?= $value_item2['id']; ?>" <?= $selected; ?>><?= $value_item2['short_name'] ?></option>
                               ...
                               <tbody>
                                  <tr name="tr_name">
                                     ...
                                     <div class="form-group ">
                                        ...
                                        <input type="hidden" class="form-control" name="old_issue_item_id" value="<?= isset($items['id'])?$items['id']:0 ?>">
                                     ...
                                     <div class="form-group ">
                                        <label class="control-label text-left col-md-12">Items</label>
                                        <div class="col-md-12">
                                           <select class="form-control custom-select select2 po_items_select po_items_select_1" name="items_id" style="width:100%" onchange="getItemUnits(this)" disabled>
                                              <?php
                                     ...
                                     <td width="20%" style="border-color: #ffffff;">
                                        ...
                                        <div class="form-group col-md-12 m-t-20">
                                           ...
                                           <div class="form-group ">                                                                     
                                              <select class="form-control custom-select select2 weight_select" style="width:100%" name="weight_item_unit_id" id="weight_item_unit_id"  >
                                                    <?php
                                              foreach($items['item_weight_unit_list'] as $key_i2=>$value_item2){
                                                 
                                                  $selected='';
                                                 if($items['item_weight_unit']==$value_item2['id']){
                                                    $selected="selected";
                                                 }
                                              ?>
                              ...
                              <tr name="tr_name">
                                 ...
                                 <input type="hidden" class="form-control" name="available_qty" >
                                    ...
                                    <div class="form-group m-t-20">
                                       <label class="control-label text-left col-md-12">Items</label>
                                       <div class="col-md-12">
                                          <select class="form-control custom-select select2 po_items_select po_items_sel po_items_select_1"  name="items_id" style="width:100%" onchange="getItemUnits(this)">
                                             <option></option>
                                          </select>
                                       </div>
...
<script src="<?= base_url(); ?>assets/js/page-js/store/matrial_issue.js?v=1.0.8"></script>
