            ...
            <div class="card-body">
               ...
               <div class="row">
                  ...
                  <div class="col-md-12 mb-3">
                     <div class="row">
                        <div class="col-md-12">
                           <span class="text-color"><h6><b>Material Recevied Information</b></h6></span><hr> 
                        </div>
                  ...
                  <div class="col-md-12 mb-2">
                     <div class="table-responsive">
                        <span class="text-color"><h6><b>Items Details 1</b></h6></span><hr> 
                        <input type="hidden" name="material_issue_id" id="material_issue_id" value="<?= isset($id)?$id:'';?>">
                        <table id="items_material_issue" class="table display table-bordered" style="text-align:center;" width="100%">
                           <!-- <thead>
                              <th>Sr._No.</th>
                              <th>Item Name</th>
