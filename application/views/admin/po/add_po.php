   ...
   <div class="col-lg-12">
      <div class="card ">
         ...
         <div class="card-body">
                        ...
                        <div class="form-group row">
                           ...
                           <div class="col-md-8">
                              <div class="input-group">
                                     ...
                                     ?>
                                 <input type="text" class="form-control <?= $class_name; ?>" placeholder="mm/dd/yyyy" name="po_date" id="po_date" value="<?= (isset($po_info['po_date']))?date('d/m/Y',strtotime($po_info['po_date'])):date('d/m/Y'); ?>">
                              ...
                              <td rowspan="2">
                                 <div class="form-group">
                                    <select class="form-control custom-select select2"  name="tax_id" style="width:100%" onchange="add_value(this);">
                                       <option data-tax_rate="0.0">Select Gst</option>
                                       <?php 
                                          // $defult_tax_rate=0;
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="form-control custom-select select2"  name="additional_tax_id" style="width:100%" onchange="add_value_additional(this);">
                                       <option  data-tax_rate="0.0">Select Additional GST</option>
                                       <?php 
                                          // $defult_tax_rate=0;
                                          foreach ($master_tax_list as $key => $value) {
                                                   $selected='';
                           ...
                           <tr class="bg-light">
                              <td>
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-12">
                                       <textarea class="form-control" placeholder="Enter your text here..." name="item_description" style="height: 90px;"><?= ($po_items['item_description'])?$po_items['item_description']:''?></textarea>
                                    </div>
                                 </div>
                              </td>
                              <td colspan="2">
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-12">
                                       <textarea class="form-control" placeholder="Enter your text here..." colspan="5" name="other_description" style="height: 90px;"><?= ($po_items['other_description'])?$po_items['other_description']:''?></textarea>
                                    </div>
                                 </div>
                              </td>
                              <td colspan="4">
                                 <div class="form-group ">
                                    ...
                                    <div class="col-md-12">
                                       <textarea class="form-control" placeholder="Enter your text here..." name="technical_description" style="height: 90px;"><?= ($po_items['technical_description'])?$po_items['technical_description']:''?></textarea>
                                    </div>
                                 </div>
                              </td>
                           </tr>
                           ...
                           <tr >
                              <td>
                                 <div class="form-group ">
                                    <label class="control-label text-left col-md-12">Description </label>
                                    <div class="col-md-12">
                                       <textarea class="form-control" placeholder="Enter your text here..." name="item_description" style="height: 90px;"></textarea>
                                    </div>
                                 </div>
                              </td>
                              <td colspan="2">
                                 <div class="form-group ">
                                    <label class="control-label text-left col-md-12">Other Description </label>
                                    <div class="col-md-12">
                                       <textarea class="form-control" placeholder="Enter your text here..." colspan="5" name="other_description" style="height: 90px;"></textarea>
                                    </div>
                                 </div>
                              </td>
                              <td colspan="4">
                                 <div class="form-group ">
                                    <label class="control-label text-left col-md-12">Technical Description </label>
                                    <div class="col-md-12">
                                       <textarea class="form-control" placeholder="Enter your text here..." name="technical_description" style="height: 90px;"></textarea>
                                    </div>
                                 </div>
                              </td>
                           </tr>
                  ...
                  <div class="col-md-6">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="col-md-6">
                           <div class="form-group row">
                              <label class="control-label text-right col-md-3">Packing &<br> Forwarding </label>
                              <div class="col-md-9">
                                  <textarea class="form-control" name="packing_forwarding" id="packing_forwarding" value="" placeholder="Enter your text here..."><?= (isset($po_info['packing_forwarding']))?$po_info['packing_forwarding']:''; ?></textarea>
                          ...
                          <div class="col-md-6">
                          <div class="form-group row">
                              <label class="control-label text-right col-md-3">Taxes &<br> Duites </label>
                              <div class="col-md-9">
                                  <textarea class="form-control" name="taxes_duites" id="taxes_duites" value="" placeholder="Enter your text here..."><?= (isset($po_info['taxes_duites']))?$po_info['taxes_duites']:''; ?></textarea>
            ...
            <option  data-tax_rate="0.0">Select Tax Value</option>
            <?php 
               foreach ($master_tax_list as $key => $value) {
                        $selected='';
...
<script src="<?= base_url() ?>assets/node_modules/ckeditor/ckeditor.js?v=1.0.1"></script>
<script src="<?= base_url() ?>assets/node_modules/ckeditor/config.js?v=1.0.1"></script>
...
<script src="<?= base_url(); ?>/assets/js/page-js/po_item_calc.js?v=1.0.7"></script>
...
//   });
    ...
    document.addEventListener('DOMContentLoaded', function() {
            // Get all textarea elements with the class 'ckeditor'
            var editors = document.querySelectorAll('textarea.ckeditor_lang');

            // Initialize CKEditor on each textarea element
            // Initialize CKEditor on each textarea element
            editors.forEach(function(editor) {
                CKEDITOR.replace(editor, {
                    ...
                    toolbar: [
                        ...
                        { name: 'basicstyles', items: ['Bold'] },
                        { name: 'paragraph', items: ['JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyBlock','JustifyLeft', 'BulletedList'] },
                        
                    ],
                    // Plugins configuration
                    extraPlugins: 'justify,format,stylescombo',
                    removePlugins: 'elementspath',
                    resize_enabled: false,
                    // Styles configuration
                    stylesSet: [
                        { name: 'Custom Style 1', element: 'h2', attributes: { 'class': 'custom-style-1' } },
