   ...
   <body>
      <table style="border: 1px solid  #000;" cellspacing="0" cellpadding="3">
         ...
         <tr class="">
               ...
               <table >
                <tr>
                    <td width="50%" align="left"><br>
                           ...
                           <strong><?= isset($vendor_name)?$vendor_name :''; ?><br></strong>
          ...
          <tr class="">
            <td colspan="3" align="center" style="border-top: 1px solid #000;border-bottom: 1px solid  #000;" >
               <strong style="margin-bottom: 0px;font-size:9px">KIND ATTN : <?= isset($contact_person_name)?$contact_person_name :''; ?></strong>
            </td>
         </tr>
          <tr class="">
            <td colspan="3" align="center" style="border-top: 1px solid #000;border-bottom: 1px solid  #000;" >
            ...
            <td colspan="3" align="left" style="border-top: 1px solid #000;border-bottom: 1px solid  #000;" ><strong>
              <table cellspacing="5" cellpadding="5">
                       ...
                       <tr>
                        ...
                        <td  width="50%"><span>Taxes & Duites :&nbsp;&nbsp; EXTRA, AS APPLICABLE</span></td>
                        </tr>
                         <tr>
                        ...
                        <td width="40%" align="center">
                           ...
                           <?php
                            ...
                            ?>
                            <img src="<?= base_url() ?>assets/uploads/company_logo/<?= isset($company_master_data['signature_image'])?$company_master_data['signature_image']:'-';?>" height="25" /><br>
                            <?php
                                }else{
                                    echo "<br>";
                                }
