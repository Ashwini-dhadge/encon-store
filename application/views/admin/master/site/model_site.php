...
<form method="post" action="<?= base_url(ADMIN.'master/Site/add_site')?>" id="form" enctype="multipart/form-data">
   <div class="modal-body">
      ...
      <div class="form-group col-md-12">
         ...
         <div>
            <input  type="text" class="form-control " required  name="short_name" value="<?= isset($site)? $site['short_name'] : ''; ?>">
         </div>
      </div>
      ...
      <div class="form-group col-md-12">
         <label >Site Inital</label>
         <div>
            <input  type="text" class="form-control " required  name="site_inital" value="<?= isset($site)? $site['site_inital'] : ''; ?>">
         </div>
      </div>
