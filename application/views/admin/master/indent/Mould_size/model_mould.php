...
<form method="post" action="<?= base_url('admin/indent/master/Blade/Mould_size/addMaster')?>" id="form" enctype="multipart/form-data">
   <div class="modal-body">
      <h4>Add Mould Size</h4>

      <hr>
      <input type="hidden" name="id" id="id" value="<?= isset($mould['id']) ? $mould['id'] : '' ?>">
      
  
      <div class="form-group col-md-12">
      <label class="">Mould Size</label>
         <div>
            <input  type="text" class="form-control " required  name="name" value="<?= isset($mould)? $mould['name'] : ''; ?>">
         </div>
      </div>
