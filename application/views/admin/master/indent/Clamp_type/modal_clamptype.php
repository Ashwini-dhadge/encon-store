...
<form method="post" action="<?= base_url('admin/indent/master/Clamp/Clamp_type/addMaster') ?>" id="ClampForm" enctype="multipart/form-data">
   <div class="modal-body">
      <h4>Add Clamp Type</h4>
      <hr>
      <input type="hidden" name="id" id="id" value="<?= isset($hub['id']) ? $hub['id'] : '' ?>">


      <div class="form-group col-md-12">
         <label class="">Clamp Type</label>
         <div>
