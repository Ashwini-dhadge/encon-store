   ...
   <div class="col-12">
      <div class="card">
         <div class="card-body">
            <div class="row">
               <div class="col-md-5">
                  <h4 class="card-title"><strong>Lead Information</strong></h4>
                                    ...
                                    <div class="sl-item">
                                       ...
                                       <div class="sl-right">
                                          <div>
                                             ...
                                             <div class="col-10">
                                                <label><b><?php echo $value['title']; ?></b></label>
                                             </div>
                                             ...
                                             <div class="col-2">
                                                <label><?php echo $value['contact_person_name']; ?></label>
                                             </div>
                                             <div class="col-2">
                                                <label><b>Contact Person Mobile No</b></label>
                                             </div>
                                             <div class="col-2">
                                                <label><?php echo $value['contact_person_mobile_no']; ?></label>
                                             </div>
                                            ...
                                            <div class="col-2">
                                             ...
                                             <div class="col-2 ">
                                                <?php echo $reminder_data[0]['start_date_time']; ?>
                                             </div> 
                                              <?php } else { ?>
                                                <div class="col-2">
                                                <label><b> </b></label>
                           ...
                           <div class="card-body">
                              <div class="row">
                                 ...
                                 <div class="col-md-7 align-self-center text-right d-none d-md-block">
                                    <button type="button" class="btn btn-info btn-theme " data-toggle="modal" data-target="# .bd-example-modal-lg">
                                    ...
                                    <!--  <button type="button" class="btn btn-info btn-theme reminderModal" data-toggle="modal" data-target="#reminderModal" >
                                       Reminders</button> -->
                                 </div>
                              </div>
                              <hr>
                              <div class="row ">
                                 <div class="col-md-12">
                                    <div class="row" style="margin-top:10px;">
                                       ...
                                       <div class="col-md-2 col-xs-6 ">
                                          <p class="text-muted"><?= (isset($name))? $name : '' ?></p>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                       ...
                                       <div class="col-md-2 col-xs-6 ">
                                          <p class="text-muted"><?= (isset($email))? $email : '' ?></p>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                       ...
                                       <div class="col-md-2 col-xs-6 ">
                                          <p class="text-muted"><?= (isset($phone))? $phone : '' ?></p>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                          <strong>Company</strong>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                          <p class="text-muted"><?= (isset($company))? $company : '' ?></p>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                          <strong>Address</strong>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                          <p class="text-muted"> <?= (isset($address))? $address : '' ?></p>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                          <strong>Country</strong>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                                          <p class="text-muted"> <?= $country_data[0]['name'] ?></p>
                                       </div>
                                       ...
                                       <div class="col-md-2 col-xs-6 ">
                                          <p class="text-muted"><?= (isset($zipcode))? $zipcode : '' ?></p>
                                       </div>
                                       <div class="col-md-2 col-xs-6 ">
                              ...
                              <div class="row">
                                 <h6 class="card-title"><strong>General Information</strong></h6>
                              </div>
                              <hr>
                              <div class="row" style="margin-top:10px;">
                                 <div class="col-md-2 col-xs-6 ">
                              ...
                              <div class="row">
                                 <h6 class="card-title"><strong>Custom Fields</strong></h6>
                              </div>
                              <hr>
                              <div class="row" style="margin-top:10px;">
                                 <div class="col-md-2 col-xs-6 ">
