                        ...
                        <div class="row">
                           ...
                           <div class="form-group col-md-3 ">
                             <label class="">Email</label>
                                             <input class="form-control " type="email" name="email" required value="<?= (isset($email))? $email : '' ?>" >
                           </div>
                           
                       
                           <div class="form-group col-md-3">
                                 <label class="control-label">City</label>
                                    <select class="form-control select2 did-floating-select cust_city_name b_city_name" required name="city_id" id="city_id" >
                                       <?php
                              ...
                              <div class="form-group col-md-3 ">
                                 <label class="control-label">State</label>
                                    <select class="form-control select2 did-floating-select cust_state_name b_state_name" required name="state_id" id="state_id" >
                                       <?php
                              ...
                              <label class="control-label">Country</label>
                                 <select class="form-control select2 did-floating-select cust_country_name b_country_name" required name="country_id" id="country_id" >
                                    <?php
                     ...
                     <div class="col-md-6 mb-3">
                        <div class="row">
                           ...
                           <div class="form-group col-md-4 ">
                              ...
                              <input class="form-control " type="text" name="b_street" required  value="<?= (isset($b_street))? $b_street : '' ?>" >
                           </div>

                           <div class="form-group col-md-4">
                            <label class="">Post Code</label>
                           <input class="form-control " type="text" name="b_post_code" required  value="<?= (isset($b_post_code))? $b_post_code : '' ?>" >
                           </div>

                           <div class="form-group col-md-4">
                              <label class="control-label">City</label>
                              <select class="form-control select2 did-floating-select b_city_name" required name="b_city_id"   >
                                 <?php
                              ...
                              <div class="form-group col-md-4">
                              <label class="control-label">State</label>
                                 <select class="form-control select2 did-floating-select b_state_name" required name="b_state_id"  >
                                    <?php
                              ...
                              <div class="form-group col-md-4">
                              <label class="control-label">Country</label>
                              <select class="form-control select2 did-floating-select b_country_name" required name="b_country_id"  >
                                    <?php
                      ...
                      <div class="col-md-6 mb-3">
                        <div class="row">
                           <div class="col-md-12">
                            ...
                            <div class="form-group col-md-4 ">
                              <label class="">Street</label>
                              <input class="form-control " type="text" name="s_street" required  value="<?= (isset($s_street))? $s_street : '' ?>" >
                           </div>

                            <div class="form-group col-md-4">
                            <label class="">Post Code</label>
                           <input class="form-control " type="text" name="s_post_code" required  value="<?= (isset($s_post_code))? $s_post_code : '' ?>" >
                           </div>

                           <div class="form-group col-md-4">
                             <label class="control-label">City</label>
                                 <select class="form-control select2 did-floating-select s_city_name" required  name="s_city_id" >
                                     <?php
                             ...
                             <div class="form-group col-md-4">
                            <label class="control-label">State</label>
                                 <select class="form-control select2 did-floating-select s_state_name" required  name="s_state_id" >
                                   <?php
                              ...
                              <div class="form-group col-md-4">
                             <label class="control-label">Country</label>
                             <select class="form-control select2 did-floating-select s_country_name" required  name="s_country_id" >
                                 <?php
