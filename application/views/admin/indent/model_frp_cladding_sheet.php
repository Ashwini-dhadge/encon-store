   ...
   <div class="modal-body">
      ...
      <div class="row">
         <div class="form-group col-md-4 mt-1">
            ...
            <input class="form-control " type="text" placeholder="" name="remark" id="remark" value="<?= isset($remark)?$remark:'';?>" required>
         </div>
         <!-- </div> -->
         <div class="form-group col-md-4 mt-1">
            <label class="">Qty</label>
            <input class="form-control " type="text" placeholder="" name="qty" id="qty" value="<?= isset($qty)?$qty:'';?>" required>
         </div>
         <div class="form-group col-md-4 mt-1">
            <label class="">Make</label>
            <input class="form-control " type="text" placeholder="" name="make" id="make" value="<?= isset($make)?$make:'';?>" required>
         </div>
      </div>
   </div>
   </div>
