   ...
   <div class="modal-body">
      ...
      <div class="row">
         <div class="form-group col-md-4 mt-1">
            ...
            <input class="form-control " type="text" placeholder="" id="dimension" name="dimension" value="<?= isset($dimension)?$dimension:'';?>" required>
         </div>
         <!-- </div> -->
         <div class="form-group col-md-4 mt-1">
         ...
         <div class="form-group col-md-4 mt-1">
            ...
            <input class="form-control " type="text" placeholder=""  id="remark" name="remark"  value="<?= isset($remark)?$remark:'';?>" required>
         </div>
         <div class="form-group col-md-4 mt-1">
            <label class="">Qty</label>
            <input class="form-control " type="text" placeholder="" id="qty" name="qty" value="<?= isset($qty)?$qty:'';?>" required>
         </div>
         <div class="form-group col-md-4 mt-1">
            <label class="">Make</label>
            <input class="form-control " type="text" placeholder="" id="make" name="make" value="<?= isset($make)?$make:'';?>" required>
         </div>
      </div>
   </div>
   </div>
