...
<form method="post" action="<?= base_url(ADMIN.'indent/Indent/saveIndentAllModule')?>" id="form" enctype="multipart/form-data">   <div class="modal-body">
      <h4>Add Bracket/Fan Guard</h4>
      <hr>
       ...
       <div class="row">
         <div class="form-group col-md-4 mt-1">
            ...
            <select class="form-control select2 did-floating-select"  id="material"  name="material" >
               ...
               <option value="MSHDG"<?= (isset($material) && ($material == "MSHDG")) ? "selected" : "" ?>>MSHDG </option>
                <option value="SS304"<?= (isset($material) && ($material == "SS304")) ? "selected" : "" ?>>SS304 </option>
                <option value="SS316"<?= (isset($material) && ($material == "SS316")) ? "selected" : "" ?>>SS316 </option>
            </select>
         </div>
         <!-- </div> -->
         <div class="form-group col-md-4 mt-1">
