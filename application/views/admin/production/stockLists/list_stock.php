...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <?php $this->load->view(ADMIN . 'production/stockLists/tbl_Stock'); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h4 class="card-title">Stock status : <span id="indent_no"></span></h4>
                        ...
                        <ul class="nav nav-tabs customtab2" role="tablist">
                            ...
                            <!-- <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile6" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-user"></i></span>
                                    <span class="hidden-xs-down">Add Creation</span></a> </li>
                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile7" role="tab" aria-selected="false"><span class="hidden-sm-up"><i class="ti-user"></i></span>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="created-status" value="30">
                                        </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select id="transfer-to" class="form-control custom-select">
                                                ...
                                                <option value="Balaji Plant">Balaji Plant</option>
                                                <option value="Encon India">Encon India</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
    ...
    <?php init_footer(); ?>
    <script src="<?= base_url(); ?>assets/js/page-js/production/stockLists.js"></script>
