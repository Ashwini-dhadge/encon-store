    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form class="" action="<?php echo base_url() ?>admin/production/Indent/CreateOrderfor_frp_headerpipe"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <select class="form-control form-control-sm did-floating-select select2" id="material" name="material">
                                                    <option value="frp_header_pipe">Frp Header Pipe</option>
                                                </select>
                                            </div>
                                                ...
                                                <table class="table table-bordered" id="specGroupTable">
                                                    <thead class="success-table">
                                                        <tr>
                                                            ...
                                                            <th style="width:10%">Length * Diameter</th>
                                ...
                                <?php } else { ?>
                                    <div class="col-md-12 mb-3">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="text-color">
                                                    <h6><b>Add Indent for Carbon Fiber Drive Shaft</b></h6>
                                                </span>
                                                <hr>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <?php if (!empty($blade_data['design_file'])) { ?>
                                                    <a href="<?= base_url(FRP_HEADER_PIPE_DESIGN_FILE . $blade_data['design_file']) ?>" target="_blank">
                                                        View File
                                                    </a>
                                                <?php } ?>
                                            </div>
                                                            ...
                                                            <?php if (!empty($specifications)) { ?>
                                                                <?php foreach ($specifications as $index => $group) { ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <input type="text" name="length_dia[]"
                                                                                value="<?= $group['length_dia']; ?>"
                                                                                class="form-control length_dia compact-input">
                                                                            <input type="hidden" name="length_dia_id[]" value="<?= $group['length_dia']; ?>">
                                                                        </td>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.copyRow', function() {
            ...
            const data = {
                ...
                length_dia: row.find('[name="length_dia[]"]').val(),
            };
            ...
            newRow.find('[name="length_dia[]"]').val(data.length_dia);
        });
        ...
        function addSpecGroupRow() {
            ...
            const row = `
                <tr data-index="${index}">
                    ...
                    <td>
                        <input type="text" name="length_dia[]" class="form-control length_dia compact-input" required>
                    </td>
                    <td class="col-action">
