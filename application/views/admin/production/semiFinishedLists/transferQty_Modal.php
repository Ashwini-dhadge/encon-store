<div class="modal-body">
    <form method="post" id="transferOrderForm"
        ...
        <input type="hidden" name="mouldsize" id="mouldSize"
            value="<?php echo isset($mould_size) ? $mould_size : ""; ?>">

        <input type="hidden" name="orderId" id="orderId" value="<?php echo isset($orderId) ? $orderId : ""; ?>">
        <input type="hidden" name="fromManualIndentNo" id="fromManualIndentNo"
            value="<?php echo isset($manualIndentNo) ? $manualIndentNo : ""; ?>">

        <!-- -------------------------------- For The Interchange Qty Start ------------------- -->

        <input type="hidden" name="interChange" id="interChange" value="<?php echo isset($interChangeType) ? $interChangeType : ""; ?>">
        <input type="hidden" name="orderQuty" id="orderQuty" value="<?php echo isset($orderQty) ? $orderQty : ""; ?>">
        <input type="hidden" name="bladeSize" id="bladeSize" value="<?php echo isset($bladeSize) ? $bladeSize : ""; ?>">
        <input type="hidden" name="aTip" id="aTip" value="<?php echo isset($aTip) ? $aTip : ""; ?>">
            ...
            <table class="table table-bordered" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo isset($orderStatus['transfer_qty']) ? $orderStatus['transfer_qty'] : ""; ?></td>
                        <td><?php echo isset($orderStatus['gap_checking_qty']) ? $orderStatus['gap_checking_qty'] : ""; ?>
                        </td>
                        <td><?php echo isset($orderStatus['primer_qty']) ? $orderStatus['primer_qty'] : ""; ?></td>
                        <td><?php echo isset($orderStatus['filler_qty']) ? $orderStatus['filler_qty'] : ""; ?></td>
                        <td><?php echo isset($orderStatus['putty_qty']) ? $orderStatus['putty_qty'] : ""; ?></td>
                        <td><?php echo isset($orderStatus['top_coat_qty']) ? $orderStatus['top_coat_qty'] : ""; ?></td>
                        <td><?php echo isset($orderStatus['balancing_qty']) ? $orderStatus['balancing_qty'] : ""; ?></td>
                        <td><?php echo isset($orderStatus['packing_qty']) ? $orderStatus['packing_qty'] : ""; ?></td>
                    </tr>
                </tbody>
            </table>
        <?php } ?>
            ...
            <table class="table table-bordered" style="width: 100%; border-collapse: collapse;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo isset($manualIndentNo) ? $manualIndentNo : ""; ?></td>
                        <td><?php echo isset($mould_size) ? $mould_size : ""; ?></td>
                        <td><?php echo isset($orderStatus['created_qty']) ? $orderStatus['created_qty'] : ""; ?></td>
                        <td><?php echo isset($orderStatus['blade_in_hand_qty']) ? $orderStatus['blade_in_hand_qty'] : ""; ?>
                        </td>
                        <!-- <td><?php echo isset($orderStatus['blade_position_qty']) ? $orderStatus['blade_position_qty'] : ""; ?>
                        </td> -->
        ...
        <div class="row justify-content-center pb-3">
            <div class="col-md-3">
                ...
                <select name="" id="" class="form-control indent select2" style="width: 100%;" required></select>
            ...
            <div class="col-md-3">
                ...
                <select name="" id="" class="form-control subIndent select2" style="width: 100%;" required></select>
        ...
        <div class="modal-footer">
            ...
            <button type="submit" class="btn   waves-effect waves-light" id="submit_btn"
                style="background-color: #48bc97;color:white;">Transfer</button>
        </div>
    </form>
