...
class Inventory extends CI_Controller
{
   ...
   function export_all_inventory_data(){
    ...
    public function view_inventory_details($id='')
    {
        ...
        $data['batch_name'] = $this->CommonModel->getData('tbl_items_inventory','','batch_no');
    ...
    { 
        ...
        // echo $this->db->last_query();die;
         ...
         $response = [
             ...
             'recordsTotal' => $count,
             'recordsFiltered' => $count,
             'final_total' => isset($finl_total)?$finl_total:0,
             'total_reserve_stock' => isset($total_reserve_stock)?$total_reserve_stock:0,
         ];
         echo json_encode($response);
