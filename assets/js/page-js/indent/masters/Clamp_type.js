...
function listClampType(data = '') {

  hubsize = $('#clamp_type').DataTable({
    ...
    ajax: {
      url: base_url + 'admin/indent/master/Clamp/Clamp_type/list_clamp_type',
      type: 'POST',
      dataSrc: "data",
      data: data,
    },
...
function clampModal(id = '') {
  ...
  $.ajax({
    url: base_url + 'admin/indent/master/Clamp/Clamp_type/clampModal',
    type: 'POST',
    data: {
      'id': id
    },
