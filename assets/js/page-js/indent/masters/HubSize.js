...
var hubsize = '';
function listHub(data='') {
  
  hubsize = $('#hub').DataTable({
        ...
        "dom": 'fl<"topbutton">tip',
            ...
            order: [[1, "desc"]],
    ajax: {
        url: base_url +'admin/indent/master/Hub/Hub_size/list_hub',
        type: 'POST',
        dataSrc: "data",
        data:data,
    },
...
console.log("jdf");
  $.ajax({
        url: base_url +'admin/indent/master/Hub/Hub_size/hubModal',
        type: 'POST',
        data: {'id':id},
        dataType:'json',
